/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 81a42431a0cfe922f438f799f72f8fed)
// Runtime types generated with workerd@1.20250507.0 2025-05-14 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SLACK_BOT_TOKEN: string;
		OPENAI_API_KEY: string;
		KnowledgeBaseAgent: DurableObjectNamespace<import("./src/index").KnowledgeBaseAgent>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN" | "OPENAI_API_KEY">> {}
}
